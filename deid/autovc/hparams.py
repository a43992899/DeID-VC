...
"""
mkdir /tmp/ruibiny
mkdir /tmp/ruibiny/data
# can replace ~ with /afs/andrew.cmu.edu/usr12/ruibiny
~/public/ossutil64 cp -r oss://stardust-data/ruibin/speech /tmp/ruibiny/data/speech -c ~/public/osscfg_hangzhou
ln -s /tmp/ruibiny/data <ID-DEID_ROOT>/data
"""
# PROJECT_ROOT = '/afs/andrew.cmu.edu/usr12/ruibiny/11751/id-deid/ID-DEID/'
PROJECT_ROOT = '/home/yrb/code/ID-DEID/'
